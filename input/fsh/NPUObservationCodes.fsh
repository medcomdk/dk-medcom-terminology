...
// Kapillærblodprøver
* $NPU#DNK05473 "Blodtryk diastolisk;Arm" "Arm—Blodtryk(diastolisk); tryk = ? mmHg" 
* $NPU#DNK05472 "Blodtryk systolisk;Arm" "Arm—Blodtryk(systolisk); tryk = ? mmHg"
* $NPU#NPU21692 "Puls;Hjerte" "Hjerte—Systole; frekv. = ? × 1/min"
* $NPU#NPU10197 "O2 sat.;Hb(kB)" "Hb(Fe; O2-bind.; kB)—Oxygen(O2); mætn. = ?"
* $NPU#NPU08676 "Legeme temp.;Pt" "Pt—Legeme; temp. = ? °C"
* $NPU#NPU19748 "C-reaktivt protein [CRP];P" "P—C-reaktivt protein; massek. = ? mg/L"
* $NPU#NPU02593 "Leukocytter;B" "B—Leukocytter; antalk. = ? × 10^9/L"
* $NPU#NPU02636 "Lymfocytter;B" "B—Lymphocytter; antalk. = ? × 10^9/L"
* $NPU#NPU02840 "Monocytter;B" "B—Monocytter; antalk. = ? × 10^9/L"
* $NPU#NPU02902 "Neutrofilocytter;B" "B—Neutrophilocytter; antalk. = ? × 10^9/L"
* $NPU#NPU01933 "Eosinofilocytter;B" "B—Eosinophilocytter; antalk. = ? × 10^9/L"
* $NPU#NPU01349 "Basofilocytter;B" "B—Basophilocytter; antalk. = ? × 10^9/L"
* $NPU#NPU22089 "Glukose;P(kB)" "P(kB)—Glucose; stofk. = ? mmol/L"
* $NPU#NPU02319 "Hæmoglobin;B" "B—Hæmoglobin(Fe); stofk. = ? mmol/L"
* $NPU#NPU01685 "Koagulationsfaktor II+VII+X [INR];P" "P—Koagulation, vævsfaktor-induceret; rel.tid(aktuel/norm; INR; IRP 67/40; proc.) = ?"
// Venøse blodprøver
* $NPU#NPU03429 "Natrium;P" "P—Natrium-ion; stofk. = ? mmol/L"
* $NPU#NPU03230 "Kalium;P" "P—Kalium-ion; stofk. = ? mmol/L"
* $NPU#NPU01536 "Klorid;P" "P—Chlorid; stofk. = ? mmol/L"
* $NPU#NPU04144 "Calcium-ion frit (ph=7,4);P" "P—Calcium-ion(frit); stofk.(pH = 7,40; proc.) = ? mmol/L"
// * #NPU02319 "B—Hæmoglobin(Fe); stofk. = ? mmol/L"
* $NPU#NPU02187 "Glukose;B" "B—Glucose; stofk. = ? mmol/L"
* $NPU#NPU21531 "Glukose;P(vB)" "P(vB)—Glucose; stofk. = ? mmol/L"
* $NPU#NPU01459 "Karbamid;P" "P—Carbamid; stofk. = ? mmol/L"
* $NPU#NPU04998 "Kreatinin;P" "P—Creatininium; stofk.(enz.) = ? µmol/L"
* $NPU#NPU18016 "Kreatini;P" "P—Creatininium; stofk. = ? µmol/L"
// Urinstix
* $NPU#NPU04206 "Protein(semikvant);U" "U—Protein; arb.k.(proc.) = ?"
* $NPU#NPU21578 "Nitrit (semikvant);U" "U—Nitrit; arb.k.(proc.) = ?"
* $NPU#NPU04207 "Glukose(semikvant);U" "U—Glucose; arb.k.(proc.) = ?"
* $NPU#NPU03987 "Leukocytter(semikvant);U" "U—Leukocytter; arb.k.(proc.) = ?"
* $NPU#NPU04208 "Hæmoglobin(semikvant);U" "U—Hæmoglobin; arb.k.(proc.) = ?"
* $NPU#NPU10504 "Acetoacetat(semikvant);U" "U—Acetoacetat; arb.k.(proc.) = ?"
// D+R
* $NPU#NPU16328 "Dyrkning(bacterium+fungus);U(midt)" "U(midtstråle)—Bacterium+fungus; taxon(proc.) = ?"
* $NPU#NPU18542 "Dyrkning (bacterium+fungus);U" "U(spec.)—Bacterium+fungus; taxon(proc.) = ?"
* $NPU#NPU16271 "Dyrkning (bacterium+fungus);Ex" "Ex—Bacterium+fungus; taxon(proc.) = ?"
// Andre målinger
* $NPU#NPU03794 "Legme højde;Pt" "Pt—Legeme; højde = ? m"
* $NPU#NPU03804 "Legme vægt;Pt" "Pt—Legeme; masse = ? kg"
