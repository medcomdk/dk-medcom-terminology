...
* ^status = #draft
* ^date = "2023-06-29"
* NPUObservationCodes#DNK05473 "Arm—Blodtryk(diastolisk); tryk =? mmHg" 
* NPUObservationCodes#DNK05472 "Arm—Blodtryk(systolisk); tryk = ? mmHg"
* NPUObservationCodes#NPU21692 "Hjerte—Systole; frekv. = ? × 1/min"
* NPUObservationCodes#NPU10197 "Hb(Fe; O2-bind.; kB)—Oxygen(O2); mætn. = ?"
* NPUObservationCodes#NPU08676 "Pt—Legeme; temp. = ? °C"
* NPUObservationCodes#NPU19748 "P—C-reaktivt protein; massek. = ? mg/L"
* NPUObservationCodes#NPU02593 "B—Leukocytter; antalk. = ? × 10^9/L"
* NPUObservationCodes#NPU02636 "B—Lymphocytter; antalk. = ? × 10^9/L"
* NPUObservationCodes#NPU02840 "B—Monocytter; antalk. = ? × 10^9/L"
* NPUObservationCodes#NPU02902 "B—Neutrophilocytter; antalk. = ? × 10^9/L"
* NPUObservationCodes#NPU01933 "B—Eosinophilocytter; antalk. = ? × 10^9/L"
* NPUObservationCodes#NPU01349 "B—Basophilocytter; antalk. = ? × 10^9/L"
* NPUObservationCodes#NPU22089 "P(kB)—Glucose; stofk. = ? mmol/L"
// * MedComObservationValueSet#NPU02319 "B—Hæmoglobin(Fe); stofk. = ? mmol/L"
* NPUObservationCodes#NPU01685 "P—Koagulation, vævsfaktor-induceret; rel.tid(aktuel/norm; INR; IRP 67/40; proc.) = ?"
// Venøse blodprøver
* NPUObservationCodes#NPU03429 "P—Natrium-ion; stofk. = ? mmol/L"
* NPUObservationCodes#NPU03230 "P—Kalium-ion; stofk. = ? mmol/L"
* NPUObservationCodes#NPU01536 "P—Chlorid; stofk. = ? mmol/L"
* NPUObservationCodes#NPU04144 "P—Calcium-ion(frit); stofk.(pH = 7,40; proc.) = ? mmol/L"
* NPUObservationCodes#NPU02319 "B—Hæmoglobin(Fe); stofk. = ? mmol/L"
* NPUObservationCodes#NPU02187 "B—Glucose; stofk. = ? mmol/L"
* NPUObservationCodes#NPU21531 "P(vB)—Glucose; stofk. = ? mmol/L"
* NPUObservationCodes#NPU01459 "P—Carbamid; stofk. = ? mmol/L"
* NPUObservationCodes#NPU04998 "P—Creatininium; stofk.(enz.) = ? µmol/L"
* NPUObservationCodes#NPU18016 "P—Creatininium; stofk. = ? µmol/L"
// Urinstix
* NPUObservationCodes#NPU04206 "U—Protein; arb.k.(proc.) = ?"
* NPUObservationCodes#NPU21578 "U—Nitrit; arb.k.(proc.) = ?"
* NPUObservationCodes#NPU04207 "U—Glucose; arb.k.(proc.) = ?"
* NPUObservationCodes#NPU03987 "U—Leukocytter; arb.k.(proc.) = ?"
* NPUObservationCodes#NPU04208 "U—Hæmoglobin; arb.k.(proc.) = ?"
* NPUObservationCodes#NPU10504 "U—Acetoacetat; arb.k.(proc.) = ?"
// D+R
* NPUObservationCodes#NPU16328 "U(midtstråle)—Bacterium+fungus; taxon(proc.) = ?"
* NPUObservationCodes#NPU18542 "U(spec.)—Bacterium+fungus; taxon(proc.) = ?"
* NPUObservationCodes#NPU16271 "Ex—Bacterium+fungus; taxon(proc.) = ?"
// Andre målinger
* NPUObservationCodes#NPU03794 "Pt—Legeme; højde = ? m"
* NPUObservationCodes#NPU03804 "Pt—Legeme; masse = ? kg"
