...
* $AckOperationOutcomeCodes#MSG_Receiver_Identifier_UNKNIWN "Receiver identifier unknown"
* $AckOperationOutcomeCodes#MSG_Receiver_Identifier_MISSING "Receiver identifier missing"
* $AckOperationOutcomeCodes#MSG_RECEIVER_UNABLE_TO_RECEIVE_MSG_TYPE "Receiver unable to receive this Message type"
* $AckOperationOutcomeCodes#MSG_VALUESET_VALUE_UNKNOWN "The value provided is not in the valueset"
* $AckOperationOutcomeCodes#MSG_CodeSystem_VALUE_UNKNOWN "The value provided is not in the CodeSystem"
